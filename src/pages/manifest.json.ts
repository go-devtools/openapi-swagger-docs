...
export function GET() {
  return new Response(JSON.stringify({ schemaVersion: 1, languages: ['en', 'zh-cn'], audiences: ['human', 'ai'], sources: {
    ...
    ginSwagger: { repository: 'https://github.com/openapi-golang/gin-swagger', commit: '60545e2ee3b400bf9225ca7e42f89660370867a2', version: 'v0.0.0-20260908020006-60545e2ee3b4' },
