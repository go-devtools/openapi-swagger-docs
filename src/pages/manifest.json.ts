...
export function GET() {
  return new Response(JSON.stringify({ schemaVersion: 1, languages: ['en', 'zh-cn'], audiences: ['human', 'ai'], sources: {
    openapi: { repository: 'https://github.com/openapi-golang/openapi', commit: '365458867d54082e317bbb1f1770e6b34cdb7f25', version: 'v0.0.0-20260907074029-365458867d54' },
    ginSwagger: { repository: 'https://github.com/openapi-golang/gin-swagger', commit: '75c4d677ae904b30ff897ce8d6a2a48c3d565a6b', version: 'v0.0.0-20260907074724-75c4d677ae90' },
