...
audience: "human"
chapter: "gin"
source: "https://github.com/openapi-golang/gin-swagger/blob/75c4d677ae904b30ff897ce8d6a2a48c3d565a6b/docs/ai-integration.md"
---
...
示例关闭 `UI.Filter`。共享 UI 展示可读模型标题、紧凑示例和枚举含义。Gin 请求绑定、响应、SSE 和流式行为分别见[请求指南](https://github.com/openapi-golang/gin-swagger/blob/75c4d677ae904b30ff897ce8d6a2a48c3d565a6b/docs/requests.md)和[响应指南](https://github.com/openapi-golang/gin-swagger/blob/75c4d677ae904b30ff897ce8d6a2a48c3d565a6b/docs/responses.md)。
