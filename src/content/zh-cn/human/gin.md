...
示例关闭 `UI.Filter`。共享 UI 展示可读模型标题、紧凑示例和枚举含义。Gin 请求绑定、响应、SSE 和流式行为分别见[请求指南](https://github.com/openapi-golang/gin-swagger/blob/641f647f97a3c125e93ada879e75aea3cb308a95/docs/requests.md)和[响应指南](https://github.com/openapi-golang/gin-swagger/blob/641f647f97a3c125e93ada879e75aea3cb308a95/docs/responses.md)。
