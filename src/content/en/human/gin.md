...
The example disables `UI.Filter`. Shared UI displays readable model titles, compact examples and enum meanings. Existing Gin binding, response, SSE and stream behavior is described in the [request guide](https://github.com/openapi-golang/gin-swagger/blob/8ce27a0af62abb6c66ed688afc5cf073736821d2/docs/requests.md) and [response guide](https://github.com/openapi-golang/gin-swagger/blob/8ce27a0af62abb6c66ed688afc5cf073736821d2/docs/responses.md).
